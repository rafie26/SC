    ...
    try {
      ...
      final sampleMessages = [
        ChatMessage(
          ...
          message: 'Halo! Bagaimana kabarnya hari ini?',
        ...
        ChatMessage(
          ...
          message: 'Halo juga! Alhamdulillah baik. Bagaimana dengan tugasnya?',
        ...
        ChatMessage(
          ...
          senderId: otherUserId,
          receiverId: currentUserId,
          message: 'Sudah selesai mengerjakan tugas matematika. Tapi ada beberapa soal yang masih bingung.',
        ...
        ChatMessage(
          ...
          senderId: currentUserId,
          receiverId: otherUserId,
          message: 'Bagus! Soal mana yang masih bingung? Bisa kita bahas bersama.',
        ...
        ChatMessage(
          ...
          senderId: otherUserId,
          receiverId: currentUserId,
          message: 'Soal nomor 5 dan 7 pak. Yang tentang persamaan kuadrat.',
        ...
        ChatMessage(
          ...
          senderId: currentUserId,
          receiverId: otherUserId,
          message: 'Baik, besok kita bahas di kelas ya. Atau kalau mau sekarang juga bisa via video call.',
